...
import 'package:postest7/home.dart';
...
class Feedback extends StatelessWidget {
  ...
  final TextControllers textCtrl = Get.put(TextControllers());
  final TextControllers deskripsiCtrl = Get.put(TextControllers());
...
class Output extends StatelessWidget {
  ...
  final TextControllers textCtrl = Get.find();
  final TextControllers deskripSiCtrl = Get.find();
  final checkBoxController cbCtrl = Get.put(checkBoxController());
